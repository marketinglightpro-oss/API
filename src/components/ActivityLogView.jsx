...
import { Activity, Clock, Shield, User, Wrench, Search } from 'lucide-react';
          ...
          {filteredLogs.length === 0 ? (
            ...
            filteredLogs.map((log) => (
              ...
              >
                ...
                <div className="flex items-center gap-1.5 text-gray-400 text-[11px] font-mono self-end sm:self-center">
